	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">
				<i class="fa fa-pencil"></i> Thêm khách hàng
			</h3>
			<c:if test="${not empty msgt}"><p style="color: red; font-weight: bold;">${msgt }</p></c:if>
		</div>
		<div class="panel-body">
			<form
				action="${pageContext.request.contextPath }/admincp/account/customer/add"
										...
										<div class="form-group required">
											...
											<div class="col-sm-10">
												<input type="text" name="username" value="${objCus.username }"
													placeholder="Username" id="input-firstname" class="form-control" />
