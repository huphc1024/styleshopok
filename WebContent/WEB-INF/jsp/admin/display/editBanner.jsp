	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">
				<i class="fa fa-pencil"></i> Cập nhật Banner
			</h3>
		</div>
		<div class="panel-body">
			<form
				action="${pageContext.request.contextPath }/admincp/display/banner/edit"
				...
				<div class="form-group required">
					<label class="col-sm-2 control-label" for="input-name">Tên
						Banner:</label>
					<div class="col-sm-10">
						<input type="text" name="name" value="${objBanner.name }"
							placeholder="Tên Banner:" id="input-name" class="form-control" />
							...
							<tbody>
								<tr id="image-row0">
									<td class="text-left"><input type="text"
										name="title" value="${objBanner.title }"
									...
									<td class="text-left" style="width: 30%;"><input
										type="text" name="link" value="${objBanner.link }"
										placeholder="Liên kết" class="form-control" />
									...
									<td class="text-center">
										<c:if test="${not empty objBanner.picture}">
											<img width="200px" height="50px" alt="" src="${pageContext.request.contextPath }/files/${objBanner.picture}">
										</c:if>
